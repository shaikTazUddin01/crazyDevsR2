    ...
    <div className="text-white pt-[60px] lg:pt-[120px]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div className="bg-[#1A1919] px-[22px] py-[32px] lg:p-10 rounded-[16px] lg:rounded-[20px]">
          <h2 className="text-[22px] lg:text-[34px] font-bold mb-9">Postiz – Scheduling & Publishing</h2>
        ...
        {/* Buffer Section */}
        <div className="bg-[#1A1919] px-[22px] py-[32px] lg:p-10 rounded-[16px] lg:rounded-[20px]">
          <h2 className="text-[22px] lg:text-[34px] font-bold ">Buffer – Scheduling & Publishing</h2>

...
const Banner = () => {
    return (
        ...
        <div className="text-center pt-[50px] lg:pt-[80px] pb:[60px] lg:pb-[120px] max-w-[1440px] mx-auto px-5 flex flex-col justify-center items-center">
            ...
            <div className='absolute end-6 md:end-5 md:right-[8%] -bottom-[12%] md:-bottom-[7%] '>
            <Image src={line2} alt='line2' className='w-[230px] md:w-[336px] h-auto' />
            </div>
            </div>
            <p className=' text-[18px] md:text-[22px] font-dm-sans font-normal leading-[23px] md:leading-[28px] text-[#c5c5c5] mb-7 lg:mb-8 tracking-wider'>Postiz&#39;s superior scheduling flow, competitor tracking, and client <br /> management make it the best Buffer alternative.</p>
            <StartButton />
        </div>
        ...
        <div className='absolute end-0 top-[2%]  lg:top-[17%] -right-[27px] md:right-[0%]'>
